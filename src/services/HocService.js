...
import PromiseAction from '../store/actions/promise.action';
...
export default (hocName, hocTarget) => {
    ...
    return class loc {
        ...
        create(obj) {
            ...
            const promiseAction = new PromiseAction(this.target, Task.CREATE, promise);
        ...
        retrieve(sortField, sortOrder, currentPage, pageSize) {
            log.trace('retrieve(sortField, sortOrder, currentPage, pageSize)',sortField, sortOrder, currentPage, pageSize)
            const promise = axios({
                method: 'GET',
        ...
        update (obj) {
            ...
            const promiseAction = new PromiseAction(this.target, Task.UPDATE, promise, obj);
        ...
        delete (obj) {
            ...
            const promiseAction = new PromiseAction(this.target, Task.DELETE, promise, obj);
