...
export class Books extends React.Component {
  ...
  getAllGenres() {
    readAllGenres().then(_genres => {
      this.setState({
        genres: _genres.data.map(genre => ({
          label: genre.name,
          value: genre._id
        }))
      });
  ...
  getAllPublishers() {
    readAllPublishers().then(_publishers => {
      this.setState({
        publishers: _publishers.data.map(publisher => ({
  ...
  save = () => {
    if (this.newBook) {
      this.props.dispatch(addBooks(this.state.book)).then(() => {
        this.props.dispatch(
          readBooks(
            this.props.sortField,
            this.props.sortOrder,
      ...
      this.props.dispatch(updateBooks(this.state.book)).then(() => {
        this.props.dispatch(
          readBooks(
            this.props.sortField,
            this.props.sortOrder,
  ...
  delete = () => {
    this.props
      .dispatch(deleteBooks(this.state.book._id))
      .then(() =>
        this.props.dispatch(
          readBooks(
            this.props.sortField,
