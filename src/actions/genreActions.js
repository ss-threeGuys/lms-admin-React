import {
  READ_GENRES_SUCCESFUL,
  READ_GENRES_PENDING,
  READ_GENRES_FAILURE,
  CREATE_GENRES_SUCCESFUL,
  CREATE_GENRES_PENDING,
  CREATE_GENRES_FAILURE,
  UPDATE_GENRES_SUCCESFUL,
  UPDATE_GENRES_PENDING,
  UPDATE_GENRES_FAILURE,
  DELETE_GENRES_SUCCESFUL,
  DELETE_GENRES_PENDING,
  DELETE_GENRES_FAILURE
