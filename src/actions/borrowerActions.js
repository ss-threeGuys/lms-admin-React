import {
  READ_BORROWERS_SUCCESFUL,
  READ_BORROWERS_PENDING,
  READ_BORROWERS_FAILURE,
  CREATE_BORROWERS_SUCCESFUL,
  CREATE_BORROWERS_PENDING,
  CREATE_BORROWERS_FAILURE,
  UPDATE_BORROWERS_SUCCESFUL,
  UPDATE_BORROWERS_PENDING,
  UPDATE_BORROWERS_FAILURE,
  DELETE_BORROWERS_SUCCESFUL,
  DELETE_BORROWERS_PENDING,
  DELETE_BORROWERS_FAILURE
